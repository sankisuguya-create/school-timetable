...
const HELP = {
  ...
  imptally: {t:"時数表からインポート",
    b:["<b>時数表に書いた1週ぶんの教科を、いま開いているクラスの週案に入れます。</b>"
       + "打ち直しをやめるための口です。",
       "<b>運び方は4つです。</b>"
       + "① 窓の「雛形を出す」を押す（いまの中身が入った形でコピーされます）"
       + "② スプレッドシートに貼る ③ 教科の1文字を、時数表のものに入れ替える "
       + "④ 見出しの行ごとコピーして、窓に貼り戻して「読む」",
       "<b>入るのは、いま開いているクラスの、この週だけです。</b>"
       + "ほかのクラスや、ほかの週には入りません。",
       ...
       "<i>はじめの人がつまずくところ：</i>行を並べ替えると取り込めません。"
       + "月〜金の5行のまま、中身だけ直してください。"
       + "読めない字があった欄は、入れずに名前を出します。"]},
  impev: {t:"年間行事からコマを作る",
